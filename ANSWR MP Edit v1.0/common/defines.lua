...
country = {
	...
	BASE_MONTHLY_DIPLOPOINTS = 10, -- Base value gain for diplomatic actions each month
	...
	MAX_RESEARCH_POINTS = 40500, -- max RP you can store for uncivs
},
...
economy = {
	...
	NUM_CLOSED_FACTORIES_PER_STATE_LASSIEZ_FAIRE = 7, -- Number of closed factories allowed per state under Lassiez Faire
...
diplomacy = {
	...
	PEACE_COST_GUNBOAT = 5000, -- Cost of forcing a defaulting country to pay its debt
	...
	LONE_BACKER_PRESTIGE_FACTOR = 0 -- prestige boost for being only defender backer in crisis
},  
